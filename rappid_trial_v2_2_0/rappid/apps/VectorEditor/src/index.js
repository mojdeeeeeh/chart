...
(function(joint, app) {
    ...
    var p1 = new app.Path({
        ...
        attrs: {
            path: {
                d: "M285.8,83V52.7h8.3v31c0,3.2-1,5.8-3,7.7c-2,1.9-4.4,2.8-7.2,2.8c-2.9,0-5.6-1.2-8.1-3.5l3.8-6.1c1.1,1.3,2.3,1.9,3.7,1.9c0.7,0,1.3-0.3,1.8-0.9C285.5,85,285.8,84.2,285.8,83z",
                fill: fill,
                stroke: stroke,
    ...
    var p2 = new app.Path({
        ...
        attrs: {
            path: {
                d: "M286.4,49c-0.9-0.9-1.4-2.1-1.4-3.4c0-1.4,0.5-2.5,1.4-3.4c0.9-0.9,2.1-1.4,3.4-1.4c1.4,0,2.5,0.5,3.4,1.4s1.4,2.1,1.4,3.4c0,1.4-0.5,2.5-1.4,3.4c-0.9,0.9-2.1,1.4-3.4,1.4C288.5,50.4,287.4,50,286.4,49z",
                fill: fill,
                stroke: stroke,
                strokeWidth: strokeWidth
            }
